const changeColor = () => {
    ...
    document.querySelector('body').style.background = `${colorArray[randomNumber]}`
    document.querySelector('.color-name').innerText = `${colorArray[randomNumber]}`
}
